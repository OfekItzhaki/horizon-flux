...
export default function TasksListTitle({
  ...
  return (
    <h1
      className={`premium-header-main cursor-text hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-200 ${isRtl ? 'text-right' : 'text-left'}`}
